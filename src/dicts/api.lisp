...
(defmethod cl-ds:add ((container functional-dictionary) location new-value)
  (cl-ds.meta:position-modification #'cl-ds:add container location :value new-value))
...
(defmethod cl-ds:insert ((container functional-dictionary) location new-value)
  (cl-ds.meta:position-modification #'cl-ds:insert container location :value new-value))


(defmethod cl-ds:erase ((container functional-dictionary) location)
  (cl-ds.meta:position-modification #'cl-ds:erase container location))


(defmethod cl-ds:erase-if ((container functional-dictionary) location condition-fn)
  (cl-ds.meta:position-modification #'cl-ds:erase-if container location :condition-fn condition-fn))
...
(defmethod cl-ds:update ((container functional-dictionary) location new-value)
  (cl-ds.meta:position-modification #'cl-ds:update container location :value new-value))
...
(defmethod cl-ds:update-if ((container functional-dictionary) location new-value condition-fn)
  (cl-ds.meta:position-modification #'cl-ds:update-if container location
                                    :value new-value
