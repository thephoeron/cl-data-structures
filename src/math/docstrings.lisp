...
(docs:define-docs
  ...
  (function chi-squared
    (:description "Performs chi-squared test on range. Programmer is expected to provide information about expected classes as fields passed to the algorithm. The combination of classes is then passed to the KEY function with each element of the range. Returned value is expected to be the count of elements of class."
