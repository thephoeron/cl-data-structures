...
(docs:define-docs
  ...
  (function to-vector
    (:description "Collects all elements into a CL:VECTOR."
     ...
     :arguments ((range "The object to aggregate.")
                 (:key "The key function used to extract value to the result vector.")
                 (:element-type ":ELEMENT-TYPE for the result vector.")
                 (:size "The initial size of the internal vector. Supplie to minimize memory allocations count.")
  ...
  (function only
    (:description "A layer function. Creates a range that skips elements that PREDICATE (KEY element) => NIL."
     :arguments ((range "A input range.")
                 (predicate "A test used to check if element should be skipped.")
                 (key "A key function used to extract a value for predicate."))
  ...
  (function without
    (:description "A layer function. Creates a range that skips elements that PREDICATE (KEY element) => T."
     :arguments ((range "A input range.")
                 (predicate "A test used to check if an element should be skipped.")
                 (key "A key function used to extract a value for the predicate."))
     :returns "Either forward, bidirectional or random-access range, depending on the RANGE."))
  ...
  (function repeat
    (:description "A layer function. Constructs new range from the RANGE. The new range is cyclic and will reset to initial position once the end is reached when calling the CONSUME-FRONT function. This happens always by default, or can be limited to a number of times by supplying optional TIMES argument. This function can be therefore used to go over the same range multiple times in the aggregation function."
  ...
  (function group-by
    (:description "Groups RANGE into partitions according to the TEST. This does not change the content of the RANGE, but will force aggregation to be performed on every group independently."
     :arguments ((range "A range that is supposed to be groupped.")
                 (key "A key function, used to extract value for TEST")
