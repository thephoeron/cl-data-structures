  ...
  (chunk *cl-data-structures*
    (level [section] @label{cl-ds intro}
      ...
      (level [list]
        ...
        @item{Complete -- this package intends to be definitive ,(lisp) data structures collection, containing both functional and mutable structures, for every use case possible.}
