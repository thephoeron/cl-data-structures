...
(with-names (cl-lore.extensions.documentation.api:<documentation-names>)
  (chunk *cl-data-structures*
    (level [section] @label{cl-ds intro}
      @title{Overview}
      [:text Cl-data-structures is a portable collection of data structures for ,(lisp). The design goals of this library are the following:]
