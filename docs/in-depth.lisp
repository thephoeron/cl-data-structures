  ...
  (chunk *cl-data-structures*
    (level [section] @label{cl-ds internals}
      ...
      (level [section]
        ...
        [:text The package introduces its own internal protocol that is used to build parts of user API responsible for container modifications. This concept is nicknamed position-modification metaprotocol and is described in this section.]
        [:text As every protocol, position-modification metaprotocol consists of classes and generic functions that are expected to be implemented for said classes.]
