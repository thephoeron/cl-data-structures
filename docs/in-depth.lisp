  ...
  (level [section]
    ...
    (level [section]
      ...
      (level [documentation]
        ...
        @docgeneric['cl-ds.meta:position-modification]
        @docgeneric['cl-ds.meta:make-bucket]
        @docgeneric['cl-ds.meta:grow-bucket]
        @docgeneric['cl-ds.meta:shrink-bucket]
        @docgeneric['cl-ds.meta:grow-bucket!]
        @docgeneric['cl-ds.meta:shrink-bucket!]
        @docgeneric['cl-ds.meta:functional-counterpart]
        @docgeneric['cl-ds.meta:destructive-counterpart]
        ))
    ...
    (level [section]
      ...
      (level [documentation]
        @pack{CL-DATA-STRUCTURES}
        @docclass['cl-ds.meta:functional-function]
        @docclass['cl-ds.meta:destructive-function]
        @docclass['cl-ds.meta:shrink-function]
        @docclass['cl-ds.meta:grow-function]
        @docclass['cl-ds.meta:insert-function]
        @docclass['cl-ds.meta:update-function]
        @docclass['cl-ds.meta:add-function]
        @docclass['cl-ds.meta:erase-function]
        @docclass['cl-ds.meta:erase-if-function]
        @docclass['cl-ds.meta:functional-insert-function]
        @docclass['cl-ds.meta:functional-update-function]
        @docclass['cl-ds.meta:functional-add-function]
        @docclass['cl-ds.meta:functional-erase-function]
        @docclass['cl-ds.meta:functional-erase-if-function]
        @docclass['cl-ds.meta:insert!-function]
        @docclass['cl-ds.meta:update!-function]
        @docclass['cl-ds.meta:add!-function]
        @docclass['cl-ds.meta:erase!-function]
